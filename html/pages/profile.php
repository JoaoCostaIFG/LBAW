...
<main>
  <div class="nav-scroller bg--body shadow-sm ">
    <nav class="nav nav-underline" aria-label="Secondary navigation">
      <a class="btn-secondary nav-link col-6 text-center me-0" aria-current="page" href="#myCarousel" data-bs-target="#myCarousel" data-bs-slide-to="0">Profile</a>
      <a class="btn-secondary nav-link col-6 text-center" href="#" data-bs-target="#myCarousel" data-bs-slide-to="1">
        Activity
  ...
  <div class="container col-4 p-2 text-center">
    <img src="../static/images/a.jpg" class="img-thumbnail d-block center-block" alt="">
  ...
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval=false>
    <div class="carousel-inner">
      ...
      <div class="carousel-item active">
        <div class="container themed-container text-left p-1">
          <h6><b>About</b></h5>
        </div>
        <div class="p-4">
            Hey! <br>
      ...
      <div class="carousel-item">
        <div class="container themed-container text-left p-1">
          <h6><b>Top Topics</b></h5>
        </div>
        <!-- Git -->
        <div class="container p-0 m-0 row">
          <div class="row themed-grid-col text-center m-0 p-0">
        ...
        <div class="container p-0 m-0 row">
          <div class="row themed-grid-col text-start m-0 p-0 answered-question">
              ...
              <div class="col-8 text-start m-0 p-2 ">
                <h5 class="m-0 p-0">Why do html pretifiers make code longer?</h4>
          ...
          <div class="row themed-grid-col text-start m-0 p-0 unanswered-question">
              ...
              <div class="col-8 text-start m-0 p-2">
                <h5 class="m-0 p-0">Why doesn't nvim support the mcfunction plugin?</h4>
          ...
          <div class="row themed-grid-col text-start m-0 p-0 unanswered-question">
              ...
              <div class="col-8 text-start m-0 p-2">
                <h5 class="m-0 p-0">How do I remove ambiguity from a CFG?</h4>
          ...
          <div class="row themed-grid-col text-start m-0 p-0 answered-question">
              ...
              <div class="col-8 text-start m-0 p-2 ">
                <h5 class="m-0 p-0">How can I remove left recursion from this grammar using factorization</h4>
