...
<hr />
<!--Form-->
<form class="row gx-0" method="POST" action="">
  <div id="right-col" class="col-md-4 p-2">
    <!-- User picture -->
    <h3>Profile Picture</h3>
    <div
      class="d-flex flex-column gap-3 align-items-center justify-content-start h-100 mt-4"
    >
      <img
        src="{{ asset('/images/user.jpg') }}"
        id="profile-picture"
        class="img-thumbnail rounded w-75 h-auto"
