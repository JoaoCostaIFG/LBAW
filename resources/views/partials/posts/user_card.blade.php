<div class="offset-0 col-12 offset-sm-7 col-sm-5 offset-md-8 col-md-4 offset-lg-9 col-lg-3 offset-xxl-10 col-xxl-2 row gx-0 align-items-center pt-1">
  <div class="col-12">
    <span class="text-muted" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Posted on {{(new \Carbon\Carbon($post->date))}}">Posted {{ (new \Carbon\Carbon($post->date))->diffForHumans() }}</span>
  </div>
