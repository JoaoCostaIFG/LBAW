...
?>
<div class="container-fluid border rounded m-3 m-sm-1 p-1 d-flex align-items-center justify-content-center" style="max-width: 35em;" id="user-report-p{{$report->post->id}}r{{$report->reporter}}">
